package edu.rosehulman.keinslc.historicaldocs;//package edu.rosehulman.historicaldocs;
...
import edu.rosehulman.keinslc.historicaldocs.utils.DocUtils;
...
public class DocListAdapter extends RecyclerView.Adapter<DocListAdapter.ViewHolder> {
    ...
    private DocListFragment.OnDocSelectedListener mCallback;
